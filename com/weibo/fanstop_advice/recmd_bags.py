...
class BagProb(object):
    ...
    def __init__(self,dir_path,order_data):
        ...
        self.midwords = {}
        self.bag_leve = {}
        self.special_bag = {'20003':'婚庆','20007':'母婴','20015':'养生','20017':'减肥','20019':'包包','20020':'医疗','20021':'咖啡','20022':'培训','20024':'宠物','20027':'戏剧','20034':'文学','20035':'文玩','20042':'烘焙','20045':'童装','20047':'红酒','20048':'绘画','20049':'美发','20051':'育儿','20053':'茶','20058':'鞋子','20059':'音乐'}
    def LoadData(self):
        #check file exist
        ...
        for (adid,values) in self.order_data.items():
            ...
            for i in range(0,len(del_list)):
                ...
                try:
                    ...
                    print "del_list:",del_list,'recmd_bags:',result_dic[adid]['recmd_bags'],'bag_code:',values['bag_code']
