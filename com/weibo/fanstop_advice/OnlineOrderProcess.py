    ...
    def OrderData(self):
        ...
        with open(self.fpath_out, 'w') as fw:
            for (adid, v) in self.order_record.items():
                ...
                if 0 == v['buy_type']:
                    fw.write(adid + '\t' + v['ad_uid'] + '\t' + v['mid'] + '\t' + v['time_f'] + '|' + v[
                        'o_flag'] + '|' + str(v['fanstop_num']) + ',' + str(v['feifen_num']) + ',' + str(
                        v['feifen_maxnum']) + '|f' + '\t' + 'NULL' + '\n')
                elif 1 == v['buy_type']:
                    fw.write(adid + '\t' + v['ad_uid'] + '\t' + v['mid'] + '\t' + v['time_f'] + '|' + v[
                        'o_flag'] + '|' + str(v['fanstop_num']) + ',' + str(v['feifen_num']) + ',' + str(
                        v['feifen_maxnum']) + '|o' + '\t' + 'NULL' + '\n')
                elif 2 == v['buy_type']:
                    tb = []
