...
def check_video(url):
    ...
    if ret == '':
        return 0
    #print ret
    video_list = ['video', 'youku.com', 'aqiyi.com', 'v.qq.com', 'tv.sohu.com', 'tudou.com', 'bilibili.com', 'pptv.com',
                  'letv.com', 'pps.tv', 'kankan.com', '56.com']
    try:
        for itm in ret['urls']:
...
if __name__ == '__main__':
    ...
    check_video(
        "url_short=http://t.cn/Rqa3knI&&url_short=http://t.cn/RtLlyQp&&url_short=http://t.cn/RtLi0kZ&&url_short=http://t.cn/Rty8I29")
